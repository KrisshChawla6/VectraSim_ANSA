...
def AspacingCFD(Growth_rate: float, Feature_angle: float, Min_length: float, Max_length: float, Sharp_angle_limit: float, Sharp_angle_length: float):
...
def AspacingSTL(chordal_deviation: Any, max_length: float, feature_angle: float, min_length: float):
...
def AutoMatch(visible: bool, shells: object, nodes: object, project_on_geometry: bool, project_2nd_order_nodes: bool, isolate: bool, move_to: str, preserve_id: str, distance: float, name: str) -> int:
...
def AutoPaste(visible: bool, shells: object, nodes: object, project_on_geometry: bool, project_2nd_order_nodes: bool, isolate: bool, move_to: str, preserve_id: str, distance: float, name: str, allow_element_collapse: bool) -> int:
...
def CheckShellTheta(shells: object, prototype_shell: object, do_fix: bool, tolerance: float) -> object:
...
def ConvertToPolyhedrals(solids: object, feature_angle: float, exclude_ANSA_layers: bool, ret_ents: bool, result_type: str, split_layers_at_sharp_convex_features: bool) -> object:
...
def ConvertHexaToSizeBox(entities: object, max_surface_length: float, max_volume_length: float) -> int:
...
def Convex(input_data: object, tolerance: float, offset_status: str, offset_mode: str, offset_value: float, module_id: str, property_id: int) -> object:
...
def CreateOGridTopology(hexa_boxes: object, free_faces: object, offset: float, pattern_type: str, pattern_coef: float, branch_faces: object, fix_intersections: bool, offset_algorithm: str) -> int:
...
def FEMToSurfArea(shells: object, ret_ents: bool, delete: bool, imprint: bool) -> object:
...
def FemTopo(tolerance: object, shells_to_be_pasted: object, max_tolerance, steps) -> int:
...
def FillGapFreeShells(SET1: object, SET2: object, RECONS: object, PART: object, PROP: object) -> object:
...
def FillHole(diameter: float, point_on_center: bool, convert_to_spot: bool, create_curve: bool, zones_num: int, part_or_property: str, with_stl: bool, force_fill_external_perimeter: bool) -> object:
...
def GetReconstructAttachedSolidsValue(labels: object) -> object:
	...
	import warnings; warnings.warn("Deprecated since version 19.0.0. Use :py:func: GetANSAdefaultsValues instead.", DeprecationWarning)
...
def HexaBlockLength(edges: object, length: float, distribution: str, is_factor: bool) -> int:
...
def HexaBlockNumber(input: object, number: str, apply_multiple_number: bool, remesh_macros: bool, apply_number_of: str, ortho_spaced: bool) -> int:
...
def HexaBlockSpacing(edges: object, algorithm: str, factor: float, dmin: float, dmax: float, dmax_dmin_ratio: float, dlimit: float, steps: int, dir: str, factor_end: float, apply_to_opposite: bool, u_parameters: object, dstart: float, dend: float) -> int:
...
def HexaBlockVolumes(boxes: object, tolerance: float, project: bool, output_filename: str, ret_ents: bool, tolerance_expr: str, apply_surface_fit: bool, project_non_associated: bool) -> object:
...
def HexaInteriorbyID(volume: int, coord: int, Maxlength: float) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 18.0.0. Use :py:func: HexaInterior instead.", DeprecationWarning)

def InitPerimeters(cons: object, remesh_macros: bool, initialize_number: bool, initialize_spacing: bool, use_ansa_defaults_values: bool) -> int:
...
def JoinMacros(entities: object, keep_mesh: bool, auto_delete_hot_points: bool, use_ansa_defaults_values: bool) -> int:
...
def ApplyNewLengthToMacros(element_length: str, perimeters: object, use_ansa_defaults_values: bool) -> int:
...
def ModifyOGridTopology(ogrid: object, offset: float, pattern_type: str, pattern_coef: float, fix_intersections: bool, offset_algorithm: str) -> int:
...
def OpenHole(coordinates: object, tolerance: float, number_of_zones: int, nodes_around_hole: int, hole_diameter: float, zone1_length: object, zone2_length: object, entities: object) -> object:
...
def OrientVolumebyID(volume: int) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 18.0.0. Use :py:func: OrientVolume instead.", DeprecationWarning)

def ProjectNodesArrayOnShells(input: object, nodes_array: object, projection_tolerance: float, maximum_projections_number: int, user_projection_mode_vector: object, zones: object, number_of_shell_zones_affected: float, move_projection_to_nearest_perimeter: float, move_to_projected_perims: float, paste_projected_and_result_edges: bool, add_results_to_set: str, cut_faces_on_result_edges: bool, cut_faces_on_result_zones: bool, release_result_edges: bool, apply_fill_gap_on_results: bool, open_closed_perimeter_hole: bool, freeze_non_single_boundary: bool, is_extend: bool) -> int:
...
def ProjectOpenHole(holes: object, add_to_set: str, cut_faces_on_holes_edges: bool, cut_faces_on_zones_edges: bool) -> object:
...
def ProjectPerimeterOnShells(input: object, perimeters: object, projection_tolerance: float, maximum_projections_number: float, user_projection_mode_vector: object, target_edges_number: float, zones: object, number_of_shell_zones_affected: float, move_projection_to_nearest_perimeter: float, move_to_projected_perims: float, add_results_to_set: str, cut_faces_on_result_edges: bool, cut_faces_on_result_zones: bool, release_result_edges: bool, freeze_non_single_boundary: bool, apply_fill_gap_on_results: bool, open_closed_perimeter_hole: bool, is_extend: bool) -> int:
...
def RefineElements(ELEMENTS_TO_BE_REFINED: object, EXTERNAL_TRANSITION_ZONE: int, MAX_REFINEMENT_STEPS: int, MIN_EDGE_LENGTH: float, NUMBER_OF_TRANSITION_ZONES: int, ALLOW_TRIAS_AT_REFINED_AREA: int, REFINEMENT_MESH_TYPE: int, SMOOTH_EXTERNAL_TRANS_ZONE: int, FREEZE_FREE_EDGES: int) -> int:
...
def RefineTrias(shells: object, number_of_transition_zones: int, preview_result: bool) -> int:
...
def ReleaseMacros(macros: object, remesh_macros: bool, keep_mesh: bool, delete_hot_points: bool, use_ansa_defaults_values: bool) -> int:
...
def SealGaps(min_distance: float, max_distance: float, width: int, feat_line_angle: float, ret_ents: bool, ignore_gaps_in_the_same_pid: bool) -> object:
...
def SetGridsThickness(grids: object, thickness: object, use_original_thickness: str) -> int:
...
def SetReconstructAttachedSolidsValue(attached_solids: str, conflicting_areas: str) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 19.0.0. Use :py:func: SetANSAdefaultsValues instead.", DeprecationWarning)
...
def SetVolumesOffsetParameters(volume: object, dist: float, steps: int, middle: int, biasing: str, factor: float) -> int:
...
def SetVolumesRotateParameters(volume: object, x: float, y: float, z: float, dx: float, dy: float, dz: float, angle: float, steps: int, biasing: str, factor: float) -> int:
...
def SetVolumesTranslateParameters(volume: object, dx: float, dy: float, dz: float, dist: float, steps: int, biasing: str, factor: float) -> int:
...
def SimplifyMacros(faces: object, fine_draft_slider: float, keep_perimeters_on_symmetry_plane: bool, maintain_sharp_edges: bool, minimum_side_length: float, minimum_perimeter_corner_angle: float, freeze_meshed_macros: bool, test_gui_result: bool) -> int:
...
def SmoothTetra() -> int:
	...
	import warnings; warnings.warn("Deprecated since version 22.0.0. Use :py:func: SolidSmooth instead.", DeprecationWarning)
...
def TetraCFDbyID(Vol_ID: int) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 18.0.0. Use :py:func: TetraCFD instead.", DeprecationWarning)
...
def VolumesDetect(method_option: int, return_volumes: bool, include_facets: bool, whole_db: bool) -> object:
...
def VolumesMap(master: object, slave: object, round: object, method: str, steps: int, part: str, prop: str, ret_ents: bool, light_volume_representation: bool) -> object:
...
def VolumesOffset(boundary_array: object, dist: float, steps: int, middle: int, bias: str, factor: float, part: object, property: object) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 19.0.0. Use :py:class: VolumesExtrude instead.", DeprecationWarning)
...
def VolumesRotate(boundary_array: object, x: float, y: float, z: float, dx: float, dy: float, dz: float, angle: float, steps: int, bias: str, factor: float, part: object, property: object) -> int:
...
def VolumesTranslate(boundary_array: object, dx: float, dy: float, dz: float, dist: float, steps: int, bias: str, factor: float, part: str, property: int) -> int:
...
def Wrap(input_data: object, tolerance: float, volume_type: str, wrap_style: str, wrap_style_argument: float, separate_sets_flags: str, separate_sets_angle: float, counter_volumes: int, part_name: str, property_id: int) -> object:
...
def xyzIsInsideVolumeMatrix(points_coordinates: object, return_all_volumes: bool, input_vols: object) -> object:
...
def NumberPerimeters(input: object, number: str, apply_multiple_number: bool, remesh_macros: bool, apply_number_of: str, use_ansa_defaults_values: bool) -> int:
...
def IntersectSolidDescription(input: object, fuse_distance: float, inflate_distance: float, ignore_same_pid: bool, ignore_same_part: bool, ignore_same_set: bool, ignore_same_neighour_zones: int, keep_separation_walls: bool, create_pid_for_separation_walls: bool, improve_mesh_quality: bool, trash_treatment: str) -> int:
...
def IntersectSkinDescription(input: object, fuse_distance: float, ignore_same_pid: bool, ignore_same_part: bool, ignore_same_set: bool, ignore_same_neighour_zones: int, improve_mesh_quality: bool) -> int:
...
def FillGapCoons(input: object, alternative: bool, improve_result_zones: int, result_set_id: int, ret_ents: bool) -> int:
...
def FillGapDraft(input: object, alternative: bool, improve_result_zones: int, result_set_id: int, ret_ents: bool) -> int:
...
def HexaBoxSweepGlide(extrusion_type: str, guideline_ents: object, box_face: object, curves: object, points: object, section_type: str, radius: float, width: float, dx: float, dy: float, dz: float, height: float, lower_base: float, upper_base: float) -> object:
...
def VoxelGeneration(shells_or_faces: object, voxel_len: float, allow_surface_intersection: bool, nth_largest: int, ret_ents: bool, different_properties_per_volume: bool, smooth_iterations: int, mesh_method: str, sharp_angle: float, coordinate_sys: object) -> int:
...
def FillGapFitted(input: object, improve_result_zones: int, result_set_id: int, ret_ents: bool) -> int:
...
def FillGapPlanar(input: object, improve_result_zones: int, result_set_id: int, ret_ents: bool) -> int:
...
def FillSingleBoundHoles(max_diameter: float, fill_ext_perim: bool, point_at_center: bool, connection_by: str, curve_at_perimeter: bool, reshape_zones: int, set_id: object, pid_id: object, ret_ents: bool, fill_method: str, part: object, geom_fill_method: str) -> int:
...
def FillSingleBoundConcavities(max_width: float, point_at_center: bool, curve_at_perimeter: bool, reshape_zones: int, set_id: object, pid_id: object, ret_ents: bool, part: object) -> object:
...
def FillFeatureLineHoles(max_diameter: float, feat_angle: float, feat_type: str, max_distortion: float, detach_triple_perimeters: bool, point_at_center: bool, curve_at_perimeter: bool, reshape_zones: int, set_id: object, pid_id: object, ret_ents: bool, fill_method: str, part: object, allow_intersecting_result_shells: bool) -> int:
...
def SuppressFeatureLines(feature_angle_limit: float, max_dist_from_prev_pos: float, shells: object) -> int:
...
def ReduceMesh(shells: object, reduce_percentage: float, distortion: float, maximum_length: float, maximum_aspect: float, distortion_angle: float) -> int:
...
def AssociateBoxEdgesToEdges(box_edges: object, target_edges: object, connect_to_cons: bool, remove_points: bool, box_edge_points: object) -> int:
...
def AssociateBoxEdgesToSurfs(box_edges: object, surface_ents: object, user_projection_mode_vector: object, remove_points: bool, box_edge_points: object, cut_geometric_faces: bool, connect_to_cons: bool) -> int:
...
def AssociateBoxFacesToSurfs(box_faces: object, surface_ents: object, user_projection_mode_vector: object, remove_points: bool, box_edge_points: object) -> int:
...
def AssociateBoxPointsToEdges(box_points: object, target_edges: object, insert_hot_point: bool) -> int:
...
def AssociateBoxPointsToSurfs(box_points: object, surface_ents: object, user_projection_mode_vector: object) -> int:
...
def ZoneCutGradual(input: object, first_height_value: float, first_height_mode: str, growth_factor: float, number: int, max_aspect: float, separate_angle: float, connect_angle: float, regenerate_macro_shells: bool, element_type: str, expand_level: int, smooth_zones: str, proximity_distance_value: float, proximity_distance_mode: str, cut_faces_on_zones: bool, zones_set_id: int, join_obstructing_perimeters: bool) -> int:
...
def ZoneCutSpecificWidth(input: object, zones_offset: object, radial_offset: bool, blended: bool, expand_level: int, smooth_zones: str, proximity_distance_value: float, proximity_distance_mode: str, cut_faces_on_zones: bool, zones_set_id: int, join_obstructing_perimeters: bool) -> int:
...
def HexaBlockShellMesh(box_faces: object, tolerance: str, project: bool, generator: str, apply_surface_fit: bool, project_non_associated: bool) -> object:
...
def VolumesGlide(boundary_array: object, guideline_array: object, distribution: str, paste_nodes: int, paste_distance: float, steps_type: str, steps: int, element_length: float, biasing: str, factor: float, reference_point: str, part: object, property: object) -> int:
...
def VolumesSweep(boundary_array: object, guideline_array: object, distribution: str, paste_nodes: int, paste_distance: float, steps_type: str, steps: int, element_length: float, biasing: str, factor: float, reference_point: str, part: object, property: object) -> int:
...
def VolumesDualSweep(boundary_array: object, guideline1_array: object, guideline2_array: object, distribution: str, paste_nodes: int, paste_distance: float, steps_type: str, steps: int, element_length: float, biasing: str, factor: float, reference_point: str, part: object, property: object) -> int:
...
def IsolateExterior(input: object, groups_number: int, classification: str, group_entities: bool, separate_at_blue_bounds: bool, separate_at_pid_bounds: bool, feature_angle: float, feature_type: str, view_point: str) -> object:
	...
	import warnings; warnings.warn("Deprecated since version 23.0.0. Use :py:func: IsolateVisibilityGroups instead.", DeprecationWarning)

def CalculateThickness(middle_entities: object, skin_entities: object, maximum_thickness: float, keep_thickness_at_junctions: int, assign_thickness_to: str, pid_thickness_step: float, use_materials_from: str) -> int:
...
def IntersectWeldingFE(input: object, thick_ratio: float, extend_distance: float, ignore_same_pid: bool, ignore_same_part: bool, ignore_same_set: bool, ignore_same_neighbour_zones: bool, improve_mesh_quality: bool) -> int:
...
def IntersectFusePanels(input: object, offset_distance: float, ignore_same_pid: bool, ignore_same_part: bool, ignore_same_set: bool, ignore_same_neighbour_zones: bool, improve_mesh_quality: bool, fuse_direction: str, dx: float, dy: float, dz: float, project_shells: object) -> int:
...
def HexaBoxOrtho(loaded_elements: object, db_or_visible: str, coordinate: object, min_flag: bool, directions: object) -> object:
...
def ExtrudeOffset(source: object, target: object, rem_source: object, connect_source: bool, direction: str, distance: float, steps: int, first_height: float, biasing: str, factor: float, factor_dir: str, side_treatment: str, angle: float, snap_to_target: bool, connect_to_target: bool, part: object, property: object) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 20.1.0. Use :py:class: VolumesExtrude instead.", DeprecationWarning)

def ExtrudeProject(source: object, target: object, rem_source: object, connect_source: bool, steps: int, first_height: float, biasing: str, factor: float, factor_dir: str, side_treatment: str, angle: float, snap_to_target: bool, connect_to_target: bool, part: object, property: object) -> int:
...
def ExtrudeRotate(source: object, rotation_axis: object, rotation_angle: float, target: object, rem_source: object, connect_source: bool, steps: int, first_height: float, biasing: str, factor: float, factor_dir: str, side_treatment: str, angle: float, snap_to_target: bool, connect_to_target: bool, part: object, property: object) -> int:
...
def ExtrudeTranslate(source: object, translation_axis: object, target: object, rem_source: object, connect_source: bool, distance: float, steps: int, first_height: float, biasing: str, factor: float, factor_dir: str, side_treatment: str, angle: float, snap_to_target: bool, connect_to_target: bool, part: object, property: object) -> int:
...
def ExtrudeSweepGlide(algorithm: str, source: object, guideline: object, target: object, rem_source: object, connect_source: bool, guide_distribution: bool, steps: int, first_height: float, biasing: str, factor: float, factor_dir: str, side_treatment: str, angle: float, snap_to_target: bool, connect_to_target: bool, part: object, property: object) -> int:
...
def ExtrudeDualSweep(source: object, guideline: object, target: object, rem_source: object, connect_source: bool, guide_distribution: bool, steps: int, first_height: float, biasing: str, factor: float, factor_dir: str, side_treatment: str, angle: float, snap_to_target: bool, connect_to_target: bool, part: object, property: object) -> int:
...
def ExtrudeMap(source: object, guideline: object, target: object, rem_source: object, connect_source: bool, guide_distribution: bool, steps: int, first_height: float, biasing: str, factor: float, factor_dir: str, side_treatment: str, angle: float, snap_to_target: bool, connect_to_target: bool, part: object, property: object) -> int:
...
def HexaBlockInitBoxEdges(box_edges: object, remesh_box_faces: bool, initialize_number: bool, initialize_spacing: bool) -> int:
...
def HexaBlockVolumesMap(box_faces: object, boxes: object, tolerance: str, project: bool, apply_surface_fit: bool, project_non_associated: bool) -> int:
...
def Redistribute(property: object, num_layers: object, layers_dir: int, growth_rate: float, modify: str, num_layers_applied: int, create_shells: bool) -> int:
...
def ChangeHeightOfLayers(property: object, increase_by: float, type: str, layers_dir: int, mod_dir: str, num_layers_applied: int) -> int:
...
def HexaBlockOrthoSmooth(box_faces: object, feature_lines: object, layers_number: int, layers_smooth_iterations: int, smooth_through_boxes: bool, smooth_base_surface_mesh: bool, smooth_iterations: int, fix_violating_solids: bool, boxes: object) -> int:
...
def CreateFillet(fillet_type: str, edges: object, chamfer_width: float, fillet_radius: float, fillet_rows: int, ret_ents: bool) -> object:
...
def ModifyFillet(fillet_type: str, shells: object, edges: object, chamfer_width: float, fillet_radius: float, fillet_rows: int, ret_ents: bool) -> object:
...
def ElementsExtrude(algorithm: str, edges: object, guideline1: object, use_edges_nodes: bool, distribution: str, ref_point: str, guideline2: object, paste_nodes: bool, tolerance: float, length: float, bias_type: str, bias_factor: float, point1: object, point2: object) -> int:
...
def RedistributeMulti(list: object, num_layers: int, layers_dir: int, growth_rate: float, modify: str, num_layers_applied: bool, create_shells: bool) -> int:
...
def ChangeHeightOfLayersMulti(list: object, increase_by: float, type: str, layers_dir: int, mod_dir: str, num_layers_applied: int):
...
def SuppressNoise(shells: object, intensity: str, only_move_nodes: bool, movement_direction: str) -> int:
...
def CavityWrap(entities: object, leak_distance: float, target_length: float, maximum_length: float, nth_largest: int, snap_nodes: bool, features_set: object) -> int:
...
def CavityVolumeTetra(shells: object, maximum_length: float, growth_rate: float, sensors_set: object) -> int:
...
def CavityVolumeHexaInterior(shells: object, maximum_length: float, buffer_zones: int, sensors_set: object) -> int:
...
def CavityVolumeHexaDominant(shells: object, boundary_length: float, maximum_length: float, nth_largest: int, buffer_zones: int, sensors_set: object, features_set: object, feature_angle: float) -> int:
...
def HexaBlockAutoCFDSpacing(input: object, growth_rate: float, feature_angle: float, min_length: float, max_length: float, sharp_edges_angle_limit: float, convex_sharp_edges_length: float, convex_sharp_edges_length_mode: str, concave_sharp_edges_length: float, concave_sharp_edges_length_mode: str):
...
def CreateTransitionZones(boxes: object, box_faces: object, direction: str, element_ratio: object) -> object:
...
def CheckSkin(skin: object, solid_description: object, distance: float, create_points: bool) -> object:
...
def CheckMiddleSurface(middle_surface: object, solid_description: object, middle_deviation_value: float, middle_deviation_type: str, bounds_deviation_value: float, bounds_deviation_type: str, thickness_deviation_value: float, thickness_deviation_type: str, check_missing_middle: bool, exclude_near_junctions: bool, l_junction_angle: float) -> object:
...
def ApplyAutoAssociation(distance: float, box_points: object, box_edges: object, box_faces: object, work_on_visible: bool, cut_geometric_faces: bool, connect_to_cons: bool, insert_hot_points: bool) -> int:
...
def HexaBlockSmooth(boxes: object, feature_lines: object, smooth_iterations: int, fix_violating_solids: bool) -> int:
...
def Create4SidedMesh(entities: object, only_4sided: bool, only_aligned: bool, corner_angle: float, smooth_type: str, split_method: str, spacing: str, elem_type: str, quad_pattern: str) -> object:
...
def LeakTool(mpar_file: str, sampling_length: float, group_leaks: bool, close_leaks: bool, chosen_properties: object, seed_points: object, leak_points: object, seal_and_wrap_inner_volumes: bool, accuracy: str) -> bool:
...
def GetNewSizeFieldSizeBoxRule(size_field: object, name: str, max_surf_len: float, max_vol_len: float):
...
def FillGapBridge(input: object, improve_result_zones: int, result_set: object, ret_ents: bool) -> int:
...
def CheckMiddleMesh(shells: object, faces: object, options: object, check_for_unconnected: bool, return_ents: bool, min_nodal_thick: float) -> object:
...
def HexaSphere(sphere_center: object, sphere_radius: float, number_of_perimeter_elements: int, light_volume_representation: bool, create_skin_shells: bool, part: object, solids_property: object, shells_property: object) -> bool:
...
def GetMiddleMeshQualityScore(shells: object, faces: object, tol_dict: object) -> object:
...
def SolidBuilder(base_elems: object, auto_build: bool, inverted_dir: bool, extrude_method: str, new_solid_height: float, snap_angle: float, create_new_nodes: bool, part: object, prop: object) -> object:
...
def ExternalDetection(input_pids: object, forced_internal_pids_sets: object, forced_external_pids_sets: object, bottom_cameras_angle: object, bottom_cameras_upper_visibility_plane: object, external_mark_limit: float, overlaping_distance: float, merge_area_limit: float, merge_elements_limit: int, merge_mark_limit: float, create_scan_results: bool):
...
def CalculateSurfaceSectionRuleParamsFromDirection(rule: object, calc_points: bool, calc_lenghts: bool, chordal_fraction: float):
...
def IsolateVisibilityGroups(input: object, groups_number: int, external_visibility_limit: float, classification: str, view_point: str, connectivity_groups_by: str, forced_internal_sets: object, forced_external_sets: object, overlapping_distance: float, merge_area_limit: float, merge_elements_limit: float, group_by_feature_lines: bool, feature_angle: float, feature_type: str) -> object:
...
def HexaBlock2DBoxCreate(type: str, entities: object, delete_original: bool, paste: bool) -> object:
...
class VolumesExtrude():
	...
	def offset(self, source: object, target: object, side: object, source_remove: object, disconnect_from_source: bool, stitch_sources: bool, connect_target: bool, collapse_free_edges: bool, direction: str, biasing: str, factor: float, biasing_direction: str, steps: int, element_length: float, distance: float, part: object, property: object, last_layer_facets_set_name: str) -> int:
	...
	def translate(self, source: object, target: object, side: object, source_remove: object, disconnect_from_source: bool, stitch_sources: bool, connect_target: bool, collapse_free_edges: bool, axis: object, biasing: str, factor: float, biasing_direction: str, steps: int, element_length: float, distance: float, part: object, property: object, last_layer_facets_set_name: str) -> int:
	...
	def revolute(self, source: object, target: object, side: object, source_remove: object, disconnect_from_source: bool, stitch_sources: bool, connect_target: bool, collapse_free_edges: bool, axis: object, biasing: str, factor: float, biasing_direction: str, steps: int, element_length: float, angle: float, part: object, property: object, last_layer_facets_set_name: str) -> int:
	...
	def project(self, source: object, target: object, side: object, source_remove: object, disconnect_from_source: bool, stitch_sources: bool, connect_target: bool, collapse_free_edges: bool, biasing: str, factor: float, biasing_direction: str, steps: int, element_length: float, part: object, property: object, last_layer_facets_set_name: str) -> int:
	...
	def dual_sweep(self, source: object, guideline1: object, guideline2: object, match_guideline1: bool, match_guideline2: bool) -> int:
...
def HexaBlockVolumeMesh(boxes: object, tolerance: float, project: bool, ret_ents: bool, tolerance_expr: str, apply_surface_fit: bool, project_non_associated: bool) -> object:
