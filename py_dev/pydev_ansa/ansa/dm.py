...
def ChangeRepresentation(entities: object, new_representation: str, property_conflicts: str, material_conflicts: str, set_conflicts: str, rbe_option: str, distance: float, mass: float, deck: str, include_connectors: bool, spc_dofs: int, coord_conflicts: str, node_conflicts: str, propsection_confilcts: str) -> object:
...
def SaveRepresentation(ents: object, save_group_or_part: str, overwrite_opt: int, skip_save_for_multi_instances: bool, save_marked_read_only: bool, save_empty_groups: bool, conflicts_option: str, export_jt: bool, export_png: bool, file_type: str, return_server_ids: bool, return_value_type: str, backup_failed_save_folder: str, export_metadb: bool) -> int:
...
def SaveSubsystems(ents: object, conflicts_option: str, spin_up_attribute: str, save_repr_file: str, export_png: str, export_jt: str, export_meta_db: str, file_type: str, save_ansa_repr_file: str, save_include_repr_file: str, autofix: object, detailed_results: bool, lbr_assign_values: object) -> object:
...
def OpenSubsystemsInNewTab(server_ids: object, subsystems: object, type: str, view: str, dm_system: str, tab_name: str, expand_all: bool, open_in_viewer: bool) -> bool:
	...
	import warnings; warnings.warn("Deprecated since version 19.0.0. Use :py:func: OpenDMObjectsInNewTab instead.", DeprecationWarning)

def SaveSimulationRun(ents: object, conflicts_option: str, spin_up_attribute: str, file_content_loadcase: str, file_content_sim_model: str, file_type: Any, use_loaded_loadcase: bool, autofix: object, use_loaded_sim_model: bool, ansa_db_save_mode: str, file_content_base_modules: str, lbr_assign_values: object) -> object:
...
def SaveSimulationModel(ents: object, file_type: Any, conflicts_option: str, spin_up_attribute: str, file_content: str, export_png: bool, export_jt: bool, autofix: object, contents_based_spin_up_attribute: str, lbr_assign_values: object) -> object:
...
def AddSimulationRun(names_values: object, file_type: str, overwrite: bool, link: bool) -> object:
...
def GetSaveRepresentationConflictOptions(entity: object, save_group_or_part: str) -> object:
...
def SaveLoadcase(ents: object, file_type: Any, conflicts_option: str, spin_up_attribute: str, file_content: str, autofix: object, lbr_assign_values: object) -> object:
...
def SaveLibraryItems(ents: object, conflicts_option: str, spin_up_attribute: str, autofix: object, lbr_assign_values: object) -> object:
...
def SendDMObjectsToOtherDM(server_ids: object, path: str) -> object:
	...
	import warnings; warnings.warn("Deprecated since version 22.0.0. Use :py:func: SendDMObjectsToDM instead.", DeprecationWarning)
...
def AddFile(file_name: str, type: str, attributes: object, server_id: str, dm_root: str, target_dm_root: str, add_attachments: bool, add_children: bool) -> int:
...
def OpenDMObjectsInNewTab(server_ids: object, entities: object, type: str, view: str, dm_system: str, tab_name: str, expand_all: bool, open_in_viewer: bool, open_in_reports_table: bool) -> bool:
...
def CollectAllSimRunPreviousHistoryLinks_dbg(server_id: str) -> object:
	...
	import warnings; warnings.warn("Deprecated since version 23.0.0. Use  GetDMReferencesForSimRun_WholePath instead.", DeprecationWarning)
