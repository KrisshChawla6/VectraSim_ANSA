...
def AddAssemblyRulesGroupToAssemblyScenario(rules_groups: object, scenario: object) -> int:
...
def AddFilterToAssemblyRule(field: str, expression: str, value: str, session: object, match: str, case_sensitive: str, filter_name: str) -> int:
...
def AutoSetConnectivityInConnections(connections: object, filter_visible: bool, output_mode: str, search_faces: bool, search_shells: bool, search_solids: bool, search_tubes: bool, search_projection: bool, search_holes: bool, use_hole_shape: bool, use_hole_proximity: bool, hole_proximity_distance: float, hole_proximity_angle: float, match_hole_params: str, search_distance: float, use_settings: bool, search_on_direction: bool, search_from: float, search_to: float, find_nearest: int, find_up_to: int, find_exactly: int, between_parts: bool, clear_connectivity: bool, tubes_feature_line_angle_limit: float, consider_part_hierarchy: bool):
...
def CollectAffectedConnectionEntities(part: object, connection_type: str, search_option: str) -> object:
...
def ConvertConnections(connections: object, point_to: str, line_to: str, create_single_line: bool) -> int:
...
def ConvertConnectivity(connections: object, connectivity_mode: str, search_nearest_dist: float):
...
def ConvertFeRepToConnection(entities: object, convert_type: str, connectivity_mode: str, check_violated_elements: bool) -> object:
...
def ConvertTubesToConnections(connection_type: str, input_faces: object, connections: bool, matched_faces: bool, unmatched_faces: bool) -> object:
...
def CreateConnectionFace(type: str, faces: object, id: int, connectivity: object, create_new_face: bool) -> object:
...
def CreateConnectionLine(type: str, curves: object, id: int, connectivity: object) -> object:
...
def CreateConnectionPoint(type: str, position: object, id: int, connectivity: object) -> object:
...
def FindDuplicateConnections(connections1: object, connections2: object, point_distance_method: str, connection_point_distance: float, average_thickness_factor: float, curve_face_distance: float, similarity: float, equivalent_connectivity: bool, same_type: bool, pair_results: bool, distance_of_projection_center: float) -> object:
...
def GetNearestPointOnBound(points: object, parts_props: object, search_dist: float) -> object:
...
def GetNearestPointOnFeature(points: object, parts_props: object, search_dist: float, feature_angle: float) -> object:
...
def RemoveDoubleConnections(connections: object, tolerance: float, equivalent_connectivity: bool, keep_id: str, move_to_middle: bool, action: str) -> int:
...
def AddFilterToAssemblyRulesGroup(field: str, expression: str, value: str, session: object, match: str, case_sensitive: str, filter_name: str) -> int:
...
def OpenConnectionManager(connections: object, mode: str, inspection_mode: bool, confirm_to_close: bool) -> bool:
...
def ReplaceConnectivity(old_connectivity: object, new_connectivity: object, connections: object, connectivity_indexes: int):
...
def CreateConnectorFromInterfacePoints(interface_points: object, match_only_identical_names: bool, matching_proximity: float, create_external_connectors_only: bool, representation: str, max_number_of_connected_points: int) -> object:
...
def FindConnectionCharacteristics(connections: object, search_pattern: bool, average_angle: bool) -> object:
...
def ApplyDensityHistogram(connection_chains: object, interval_params: object, densities: object):
