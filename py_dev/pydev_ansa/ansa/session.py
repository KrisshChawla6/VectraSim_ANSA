...
def BenchmarkFPS(frames: int, ctrl_flag: int, shift_flag: int, times_to_press_benchmark: int) -> object:
...
def SaveSettings() -> int:
	...
	import warnings; warnings.warn("Deprecated since version 20.0.0. Use :py:func: BCSettingsWriteFile instead.", DeprecationWarning)
