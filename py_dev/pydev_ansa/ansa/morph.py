...
def ConvertMorphToSizeBox(morphs_matrix: object, max_surface_length: float, max_volume_length: float) -> int:
...
def MorphAlign(id_curve_or_plane: int, curve_or_plane: str, mpoints: object, flag: int) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 17.1.0. Use :py:func: AlignBoxPoints instead.", DeprecationWarning)

def MorphAlign3Grids(grid1: object, grid2: object, grid3: object, m1: object, flag: int) -> int:
...
def MorphContents(morphes: object) -> object:
	...
	import warnings; warnings.warn("Deprecated since version 21.0.0. Use :py:func: CollectEntities instead.", DeprecationWarning)
...
def MorphCylindrical(curve: object, rad1: float, rad2: float, auto_sort: bool) -> object:
...
def MorphLoad(morphes_to_load: object, entities_to_load: object, db_or_visib: str, strict_project: bool, keep_loaded: bool) -> int:
...
def MorphMappingDeformations(deformation_parameter: object, moved_elements: object, sampling_points: int, work_on_visible: bool, bound_entities: object, max_displacement: float) -> int:
...
def MorphMultBoxAbsDis(coord: object, load: object, min_flag: int, distance: float, boxesType: int) -> object:
...
def MorphOffset(morph_hatces: object, offset_value: float, flag_morphing: int) -> object:
...
def MorphOrtho(loaded_elements: object, db_or_visible: str, coordinate: object, min_flag: bool, directions: object) -> object:
...
def MorphParPrj(dx: float, dy: float, dz: float, morph: object, morph_edge: object) -> int:
...
def MorphScale(morph: object, flag: int, d1: float, d2: float, d3: float, d4: float) -> int:
...
def MorphSplit(box_points: object, non_isoparam: bool, fit_new_skin_edges: bool, box_edges: object, number_of_splits: int, work_on: str) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 21.0.0. Use :py:class: BoxSplit instead.", DeprecationWarning)
...
def PerformDoeStudy(opt_task_id: int, comb_file: str, dir_path: str, solver: str, solver_session_file: str, post_processing: str, meta_session_file: str, meta_response_file: str, empty_experiments_directory: bool, single_directory: bool, pre_processing: str, save_database: bool, dm_signature: object, sim_run_save_action: str, detailed_results: bool=False, upload_doe_study: bool=False, existing_doe_study: str=None) -> int:
...
def MorphEdgeFitOnSurfs(edges: object, surface_ents: object, add_pnts: int, search_distance: float, user_projection_mode_vector: object) -> int:
...
def MorphSlFeatureCurve(elements: object, curve: object, dist: float, orient: int, copy: int) -> object:
	...
	import warnings; warnings.warn("Deprecated since version 21.1.0. Use :py:class: DCFeatureSlide instead.", DeprecationWarning)

def MorphSlFeatureRotate(elements: object, p1: object, angle: float, origin_x: float, origin_y: float, origin_z: float, dx: float, dy: float, dz: float, copy: int) -> object:
...
def MorphSlFeatureTransl(elements: object, p1: object, dist: float, dx: float, dy: float, dz: float, copy: int) -> object:
...
def MorphSweepGlide(extrusion_type: str, guideline_ents: object, box_face: object, curves: object, points: object, section_type: str, radius: float, width: float, dx: float, dy: float, dz: float, height: float, lower_base: float, upper_base: float) -> object:
...
def MorphParamCreateTranslate(name: str, morph_points: object, coord: object, dx: float, dy: float, dz: float) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 17.1.0. Use :py:func: NewParameterTranslate instead.", DeprecationWarning)
...
def MorphParamCreateEdgeFit(name: str, morph_edges: list, curves: list) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 17.1.0. Use :py:func: NewParameterEdgeFit instead.", DeprecationWarning)
...
def MorphParamCreateExtend(name: str, morph_points: object, morph_edges: object) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 17.1.0. Use :py:func: NewParameterExtend instead.", DeprecationWarning)
...
def MorphParamCreateOffset(name: str, morph_faces: object) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 17.1.0. Use :py:func: NewParameterOffset instead.", DeprecationWarning)
...
def MorphParamCreateRadiusOuter(name: str, morph_faces: object) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 17.1.0. Use :py:func: NewParameterRadiusOuter instead.", DeprecationWarning)
...
def MorphParamCreateRadiusInner(name: str, concentric_edges: object) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 17.1.0. Use :py:func: NewParameterRadiusInner instead.", DeprecationWarning)

def MorphParamCreateSetsAlign(name: str, s_elements: object, s_aligned: object, s_retained: object, s_target: object, search_distance: float) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 17.1.0. Use :py:func: NewParameterDFMAlign instead.", DeprecationWarning)

def MorphParamCreateSetsOffset(name: str, s_elements: object, s_offset: object, s_retained: object) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 17.1.0. Use :py:func: NewParameterDFMOffset instead.", DeprecationWarning)

def MorphParamCreateSetsTranslate(name: str, s_elements: object, s_translate: object, s_retained: object, dx: float, dy: float, dz: float) -> int:
...
def MorphParamCreateSetsRotate(name: str, s_elements: object, s_rotate: object, s_retained: object, x: float, y: float, z: float, dx: float, dy: float, dz: float) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 17.1.0. Use :py:func: NewParameterDFMRotate instead.", DeprecationWarning)
...
def MorphParamCreateAngle(name: str, morph_edges: object) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 17.1.0. Use :py:func: NewParameterAngle instead.", DeprecationWarning)

def MorphParamCreateRotate(name: str, morph_points: object, coord: object, x: float, y: float, z: float, dx: float, dy: float, dz: float) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 17.1.0. Use :py:func: NewParameterRotate instead.", DeprecationWarning)
...
def MorphParamCreateDeformation(name: str, affected: str) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 17.1.0. Use :py:func: NewParameterDeformation instead.", DeprecationWarning)

def MorphParamCreateScale(name: str, morph_points: object, x: float, y: float, z: float) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 17.1.0. Use :py:func: NewParameterScale instead.", DeprecationWarning)
...
def MorphParamCreateUserTangent(name: str, morph_tang: object) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 17.1.0. Use :py:func: NewParameterUserTangent instead.", DeprecationWarning)

def MorphParamCreateDFMFitEdges(name: str, edge_fit_args: object, entities: object, bounds: object, autobounds: bool) -> int:
...
def MorphParamCreateDFMFitSurfaces(name: str, surafce_fit_args: object, morphed: object, bounds: object, autobounds: bool) -> int:
...
def MorphParamCreateDFMTranslate(name: str, translate_arg: object, entities: object, bounds: object, autobounds: bool) -> int:
...
def MorphParamCreateDFMRotate(name: str, rotate_args: object, entities: object, bounds: object, autobounds: bool) -> int:
...
def MorphParamCreateDFMScale(name: str, scale_args: object, entities: object, bounds: object, autobounds: bool) -> int:
...
def MorphParamCreateDFMTransform(name: str, transformed_args: object, entities: object, bounds: object, autobounds: bool) -> int:
...
def MorphParamCreateDFMOffset(name: str, offset: object, entities: object, bounds: object, autobounds: bool) -> int:
...
def MorphParamCreateSlideFeatureTranslate(name: str, elements: object, coord: object, dx: float, dy: float, dz: float) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 17.1.0. Use :py:func: NewParameterSlideFeatureTranslate instead.", DeprecationWarning)

def MorphParamCreateSlideFeatureRotate(name: str, elements: object, coord: object, x: float, y: float, z: float, dx: float, dy: float, dz: float) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 17.1.0. Use :py:func: NewParameterSlideFeatureRotate instead.", DeprecationWarning)

def MorphParamCreateSlideFeatureScale(name: str, elements: object, x: float, y: float, z: float) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 17.1.0. Use :py:func: NewParameterSlideFeatureScale instead.", DeprecationWarning)

def MorphParamCreateSlideFeatureCurve(name: str, elements: object, curve: object, follow_orientation: bool) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 17.1.0. Use :py:func: NewParameterSlideFeatureCurve instead.", DeprecationWarning)
...
def MorphParamCreateDFMAlign(name: str, align_args: object, entities: object, bounds: object, autobounds: bool) -> int:
...
def MorphParamCreateTailoredBlank(entities: object, properties: object, lengths: object, origin: object, normal: object, trajectory: object, movement: int, cut_mesh: bool, reconstruct: bool, zones: int, name: str) -> int:
	...
	import warnings; warnings.warn("Deprecated since version 17.1.0. Use :py:func: NewParameterTailoredBlank instead.", DeprecationWarning)

def MorphPointProjectToContainer(box_points: object, target_entities: object, offset: float, coordinate_system: object, freeze_x_axis: bool, freeze_y_axis: bool, freeze_z_axis: bool) -> int:
...
def CreateStamp(stamp_type: str, stamp_entities: object, stamp_parameters: object, direction_points: object, invert_direction: bool, auto_reconstruct: object, add_to_set: int, save_morph_parameter: bool, return_characteristics: bool, top_is_width: bool, detached_feature: object, exclude_feature_recon: bool) -> object:
	...
	import warnings; warnings.warn("Deprecated since version 21.0.0. Use :py:class: Create instead.", DeprecationWarning)

def CreateBead(bead_type: str, bead_entities: object, bead_parameters: object, invert_direction: bool, auto_reconstruct: object, add_to_set: int, save_morph_parameter: bool, direction_points: object, return_characteristics: bool, top_is_width: bool, detached_feature: object, exclude_feature_recon: bool) -> object:
...
def CreateFlangedOpening(open_type: str, open_entities: object, open_parameters: object, direction_points: object, invert_direction: bool, auto_reconstruct: object, add_to_set: int, save_morph_parameter: bool, return_characteristics: bool, top_is_width: bool, detached_feature: object, exclude_feature_recon: bool) -> object:
...
def CreateOpening(open_type: object, open_entities: object, open_parameters: object, direction_points: object, invert_direction: bool, auto_reconstruct: object, add_to_set: int, save_morph_parameter: bool) -> object:
...
def CreateRib(rib_type: str, rib_entities: object, rib_parameters: object, add_to_set: int, auto_reconstruct: object, exclude_feature_recon: bool) -> object:
...
def SimulateDoeWindow(mainitem: object, values: str, designs: int, algorithm: str, generate: bool, experiments_file: str) -> int:
...
def MorphConstraintPlanar(entities: object, morphed: object, bounds: object, autobounds: bool) -> object:
	...
	import warnings; warnings.warn("Deprecated since version 21.0.0. Use :py:class: ConstraintPlanar instead.", DeprecationWarning)
...
def MorphConstraintRigid(entities: object, morphed: object, bounds: object, autobounds: bool) -> object:
	...
	import warnings; warnings.warn("Deprecated since version 21.0.0. Use :py:class: ConstraintRigid instead.", DeprecationWarning)
...
def MorphConstraintScaled(entities: object, morphed: object, bounds: object, autobounds: bool) -> object:
	...
	import warnings; warnings.warn("Deprecated since version 21.0.0. Use :py:class: ConstraintScaled instead.", DeprecationWarning)
...
def MorphConstraintDirectional(entities: object, morphed: object, bounds: object, coordinate: object, x_status: str, y_status: str, z_status: str, autobounds: bool) -> object:
	...
	import warnings; warnings.warn("Deprecated since version 21.0.0. Use :py:class: ConstraintDirectional instead.", DeprecationWarning)

def MorphConstraintPathFollower(entities: object, morphed: object, bounds: object, path: object, autobounds: bool) -> object:
	...
	import warnings; warnings.warn("Deprecated since version 21.0.0. Use :py:class: ConstraintPathFollower instead.", DeprecationWarning)

def MorphSplitProject(box_edge: object, points: object, fit_new_skin_edges: bool, work_on: str) -> int:
...
def Morph2DCreate(type: str, entities: object, thickness: float, delete_original: bool, paste: bool, convert_to_ortho: bool) -> object:
...
def MorphEdgesRedistribute(box_edges: object, factor: float, nodal_number_redistribution: bool) -> int:
...
def MorphCollapse(box_face: object, box_edge: object, target_point: object, collapse_entire_topology: bool):
...
def CoarseBoxTopology(boxes: object, box_edge: object, coarse_ratio: str, distance: float):
...
def MorphParamCreateTransform(name: str, morph_points: object, transform_points: object) -> int:
...
def MorphCreateMorphAlignArgs(entities: object, target_entities: object, distance: float, offset: float, user_direction: object, align_to_midplane: bool, align_on_geometry: bool) -> object:
	...
	import warnings; warnings.warn("Deprecated since version 17.1.0. Use :py:func: NewMorphAlignArgs instead.", DeprecationWarning)
...
def NewParameterDFMFitEdges(args: object, entities: object, bounds: object, autobounds: bool, name: str) -> object:
	...
	import warnings; warnings.warn("Deprecated since version 21.0.0. Use :py:class: DFM instead.", DeprecationWarning)
...
def NewDFMFitEdgesArgs(source: object, target: object) -> object:
	...
	import warnings; warnings.warn("Deprecated since version 21.0.0. Use :py:class: DFMFitEdges instead.", DeprecationWarning)
...
def NewDFMFitSurfsArgs(source_area: object, target_area: object, source_points: object, target_points: object) -> object:
	...
	import warnings; warnings.warn("Deprecated since version 21.0.0. Use :py:class: DFMFitSurfaces instead.", DeprecationWarning)
...
def NewDFMTranslateArgs(translated: object, dx: float, dy: float, dz: float) -> object:
	...
	import warnings; warnings.warn("Deprecated since version 21.0.0. Use :py:class: DFMTranslate instead.", DeprecationWarning)
...
def NewDFMScaleArgs(scaled: object, x: float, y: float, z: float) -> object:
	...
	import warnings; warnings.warn("Deprecated since version 21.0.0. Use :py:class: DFMScale instead.", DeprecationWarning)
...
def NewDFMTransformArgs(transformed: object, src_coord: object, trg_coord: object) -> object:
	...
	import warnings; warnings.warn("Deprecated since version 21.0.0. Use :py:class: DFMTransform instead.", DeprecationWarning)
...
def NewDFMAlignArgs(entities: object, target_entities: object, target_axis: object, target_plane: object, include_thickness: bool, max_distance: float, user_direction: object) -> object:
	...
	import warnings; warnings.warn("Deprecated since version 21.0.0. Use :py:class: DFMAlign instead.", DeprecationWarning)
...
def NewParameterDFMAlign(args: object, entities: object, bounds: object, autobounds: bool, name: str) -> object:
...
def NewParameterExtend(morph_points: object, morph_edges: object, name: str) -> object:
	...
	import warnings; warnings.warn("Deprecated since version 18.0.0. Use :py:func: NewParameterSlideBoxPoints instead.", DeprecationWarning)
...
def BoxesByWireframe3D(curves: object, box_type: str, max_surf_len: float, max_vol_len: float) -> object:
...
def AlignBoxPoints(entities: object, target_entities: object, distance: float, offset: float, user_direction: object, align_to_midplane: bool, align_on_geometry: bool) -> int:
...
def DCFeatureSlideApply(entity: object, dx: float, dy: float, dz: float, rx: float, ry: float, rz: float, fx: float, fy: float, fz: float):
...
def DCFeatureSlideSurfaceApply(entity: object, ds: float, dt: float, rw: float, fs: float, ft: float):
...
def DCFeatureCopyApply(entity: object, dx: float, dy: float, dz: float, rx: float, ry: float, rz: float, fx: float, fy: float, fz: float, steps: int):
...
def DCFeatureCopySurfaceApply(entity: object, ds: float, dt: float, rw: float, fs: float, ft: float, steps: int):
...
def MorphConstraintFlange(entities: object, contacts: object, morphed: object, bounds: object, autobounds: bool, align: str, offset: float) -> object:
	...
	import warnings; warnings.warn("Deprecated since version 21.0.0. Use :py:class: ConstraintFlanges instead.", DeprecationWarning)

def VideoFromEntities(filename: str, parameters: object, initial_final: object, frames: int, duration: float, lock_view_time: object, images_per_sec: int):
...
def MorphSplitToHexa(box_faces: object, tangency: str, preserve_local_shape: bool, fit_new_skin_edges: bool, work_on: str, ret_ents: bool) -> object:
...
def DCSymmetry(design_change: object) -> object:
	...
	import warnings; warnings.warn("Deprecated since version 21.1.0. Use :py:class: DCPosition instead.", DeprecationWarning)

def OptimizationTool(optimization_task: object, load_experiments: str, export_file: str, dv_file: str, doe_algorithm: str, number_of_designs: int, hide_buttons: bool, show_deviation: bool, clear_table: bool, save_in_dm: bool, revert_changes: bool, save_ansa_db: bool, save_animation: bool, working_directory: str) -> int:
...
def SculptingSmooth(smooth_area: object, smooth_algorithm: str, distortion: float, angle: float, intensity: float, iterations: int, frozen_area: object) -> int:
...
class Create:
	...
	def __init__(self, invert_direction: bool, auto_reconstruct: object, set_id: int, save_morph_parameter: bool) -> object:
...
class DFMRotate:
	...
	def set_rotate_axis(self, x: float, y: float, z: float, dx: float, dy: float, dz: float):
...
class DFMAlign:
	...
	def set_target_plane(self, x: float, y: float, z: float, dx: float, dy: float, dz: float):
	...
	def set_target_axis(self, x: float, y: float, z: float, dx: float, dy: float, dz: float):
...
class Form:
	...
	def set_user_section(self, x: float, y: float, z: float, dx: float, dy: float, dz: float):
