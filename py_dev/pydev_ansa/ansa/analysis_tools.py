...
class RunSolver():
	...
	def __init__(self, window_caption: str, initial_actions: object, query_status_interval: float=3.0) -> object:
...
class RunSolverTextViewer():
	...
	def __init__(self, name: str, is_console: bool=False, supports_errors: bool=False, supports_warnings: bool=False, supports_notes: bool=False) -> object:
