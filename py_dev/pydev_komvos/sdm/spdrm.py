...
class question:
	def loadQuestion(request: str, answers: object, mode: int, title: str) -> str:
...
class fileChooser:
	def selectDirectories(startDir: str) -> object:
	...
	def selectFiles(startDir: str, filesType: int, extensions: object) -> object:
	...
	def selectFile(startDir: str, filesType: str, extensions: object) -> str:
