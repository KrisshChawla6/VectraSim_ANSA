...
class DMObject():
	...
	::
		...
		dmobj = sdm.dm.DMObject(server_id="6", type="Subsystem")
...
def GetChildIdsWithRelativePositions(object_id: str) -> Callable:
...
def RefreshEntriesInCurrentTab(server_ids: object, type: str) -> bool:
...
def GetUserSettings(keywords: object) -> object:
...
def SetUserSettings(settings: object) -> int:
...
def checkUpdatesForEntities(entities_handle_ids: object, update_options: object, mode: str, owners: str, show_list: bool) -> object:
...
def checkUpdatesForFiles(file_handle_ids: object, show_list: bool) -> object:
...
def selectComponentsFromQueryResults(json_query: str, sel_mode: str) -> object:
...
def selectDMItemsByPathAndType(dm_path: str, DM_item_types: object, sel_mode: str, is_library_item: bool) -> object:
...
def selectFilesAndFolders(start_in_path: str, sel_filter: str, sel_mode: str) -> object:
...
def selectDMItemsByPathTypeQueryResults(dm_path: str, DM_item_types: object, json_query: str, sel_mode: str) -> object:
...
def loadDMFoldersOfPath(title: str, dm_path: str) -> object:
...
def selectDataFromDataTree(start_in_path: str, sel_filter: object, sel_mode: str) -> object:
...
def selectFilesAndFoldersByPathTypeQueryResults(dm_path: str, sel_filter: str, json_query: str, sel_mode: str) -> object:
...
def selectLibraryItemsByPathTypeQueryResults(dm_path: str, library_item_types: object, json_query: str, sel_mode: str) -> object:
...
def checkUpdatesForLibraryItems(handle_ids: object, update_options: object, mode: str, owners: str, show_list: bool) -> object:
