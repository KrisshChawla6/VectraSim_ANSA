...
def AparameterTaskItemLinkToAparameter(
    task_item_ref: object, ansa_parameter_ref: object, expression: str
) -> int:
    """
...
def MorphparameterTaskItemLinkToMorphparameter(
    task_item_ref: object,
    morph_parameter_ref: object,
    after_morph_action: str,
    expression: str,
) -> int:
    """
...
def MoveTaskItem(
    task_item_ref_to_move: object, target_task_item_ref: object, drop_position: str
) -> int:
    """
...
def SetResponseItemData(
    response_item: object, ansa_entity: object, ansa_field: str
) -> int:
    """
