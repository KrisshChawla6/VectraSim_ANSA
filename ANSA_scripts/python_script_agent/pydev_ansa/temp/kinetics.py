...
def Vx(
    to_marker: str, from_marker: str, along_marker: str, reference_marker: str
) -> float:
    """
...
def ResultsWriteToXML(
    kin_result: object, file_name: str, output_adams_view: bool, adams_name: bool
) -> int:
    """
...
def ConfigSetParameters(
    ...
    lock_rotate_y: bool,
    lock_rotate_z: bool,
    matching_points_by_actuator_joint: bool,
    sp_body: object,
) -> int:
    """
...
def ContactBodySetData(
    kin_contact: object,
    kin_body: object,
    shape: str,
    thickness: float,
    thickness_scale: float,
    smooth_subdiv_lev: int,
    smooth_feat_ang: float,
) -> int:
    """
...
def Orient(
    orientation_system: float, component: float, to_marker: str, from_marker: str
) -> float:
    """
...
def Joint(
    joint: str, computed_at_marker: str, component: str, ref_marker: str
) -> float:
    """
...
def Jprim(
    jprim: str, computed_at_marker: str, component: str, ref_marker: str
) -> float:
    """
...
def Motion(
    motion: str, computed_at_marker: str, component: str, ref_marker: str
) -> float:
    """
...
def Force(
    force: str, computed_at_marker: str, component: str, ref_marker: str
) -> float:
    """
...
def HBMTreeJointRotate(
    joint: object, total_angle: float, axis: int, step: float
) -> bool:
    """
...
def AutoMech(
    ...
    joints: object,
    elements_to_disregard: object,
    create_dummy_kin_model: bool,
    create_sets_with_properties: bool,
    create_kinetic_forces: bool,
    group_name: str,
) -> object:
    """
...
class FlexBody:
    ...
    def __init__(
        ...
        filename: str,
        body: object,
        delete_body_contents: bool,
        align_with_body_cog: bool,
    ) -> object:
        """
...
def HBMReadPosFile(
    file: str, step: float = 5.0, hbm_random_element: object = None
) -> bool:
    """
