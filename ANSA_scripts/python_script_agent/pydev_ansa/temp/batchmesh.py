...
def GetNewVolumeScenario(
    name: str, auto_detect: bool, parts: str, include_facets: bool
) -> object:
    """
...
def SaveMeshingSession(
    session: object, filename: str, only_failed: int, single_seperate: str
) -> int:
    """
...
def CopySessionParameters(
    session: object, mesh_parameters: bool, quality_criteria: bool
) -> int:
    """
...
def GetNewLayersArea(
    ...
    name: str,
    first_height: float,
    first_height_method: str,
    growth_factor: float,
    zero_thickness: bool,
    layers_prop_name: str,
    number_of_layers: int,
    additional_outer_layers: int,
    orthogonal_layers: int,
    smooth_top_cap: bool,
    switch_to_variable_growth_rate: bool,
    varibable_growth_rates: str,
) -> object:
    """
