...
class process:
    ...
    def instantiateWorkflow(
        workflow_handle_id: int, input_slot_values: object, input_dir: str
    ) -> int:
        """
    ...
    def updateNodeProgress(
        node_id: int, node_progress: float, user_data: object, dir: str
    ) -> int:
        """
    ...
    def getRoot() -> str:
        ...
        See Also
        --------
        spdrm.process.setRoot, spdrm.process.removeRoot
    ...
    def setRoot(url: str, username: str, password: str, role: str, ticket: str) -> int:
        ...
        * Do not provide anything and search if there is an already stored ticket
        ...
        See Also
        --------
        spdrm.process.getRoot, spdrm.process.removeRoot
    ...
    def removeRoot():
        ...
        See Also
        --------
        spdrm.process.setRoot, spdrm.process.getRoot
    ...
    class PexDriver:
        ...
        def instantiateWorkflow(
            self, workflow_handle_id: int, input_slot_values: object, input_dir: str
        ) -> int:
            """
        ...
        def executeScriptAction(
            self, action_handle_id: int, dm_item_ids: object, fun_args: object
        ) -> bool:
            """
