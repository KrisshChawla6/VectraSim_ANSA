...
def Merge(
    ...
    material_offset: str,
    set_offset: str,
    merge_sets_by_name: bool,
    paste_nodes_by_name: bool,
    paste_nodes_by_name_tolerance: float,
    paste_cons_by_name: bool,
    merge_parts: bool,
    autoposition_parts: bool,
    create_instances: bool,
    model_action: str,
    coord_offset: str,
    node_offset: str,
    auto_fit_models: bool,
    propsection_offset: str,
    eos_offset: str,
    hourglass_offset: str,
    function_offset: str,
) -> int:
    """
...
def OpenPartManager(view_mode: str) -> int:
    ...
    warnings.warn(
        "Deprecated since version 17.0.0. Use :py:func: OpenModelBrowser instead.",
        DeprecationWarning,
    )
...
def PrintToFile(
    ...
    warnings.warn(
        "Deprecated since version 18.0.0. Use :py:func: SnapShot instead.",
        DeprecationWarning,
    )
...
def OpenModelBrowser(
    entity_type: str,
    view_mode: str,
    main_tabs: object,
    current_main_tab: str,
    info_tabs: object,
    current_info_tab: str,
    side_panel: bool,
    current_side_panel_tab: str,
    profile: str,
) -> bool:
    """
...
def SetCurveProperties(
    ...
    dash_style: str,
    offset_on: bool,
    curve_attributes: object,
    curve_points_attributes: object,
):
    """
...
def SetPlotProperties(
    plot: object, title: str, show_legend: bool, legend_position: str, show_grid: bool
):
    """
...
def DetectThermalLinks(
    dist: float, entities: object, excl_angle: int, self_link: bool
) -> object:
    """
...
class UnitSystem:
    ...
    @classmethod
    def __init__(
        cls, length: str, mass: str, time: str, temperature: str, kinetics_force: str
    ) -> object:
        """
    ...
    def set_current(
        self, unit_system: object, apply_to_settings: bool, apply_to_models: bool
    ):
        """
...
class FileCacher:
    ...
    def lookup_dm_file(
        self, server_id: str, file_type: str, dm_root: str, timestamp_policy: str
    ) -> object:
        """
    ...
    def add_keyless_file(
        self, path: str, importance: str, gather_siblings: str, delete_source: str
    ) -> int:
        """
...
def XlsxSetCellValue(
    file: object, sheet: object, row: int, column: int, value: object
) -> int:
    """
...
def XlsxMergeCells(
    file: object, sheet: str, row1: int, column1: int, row2: int, column2: int
) -> object:
    """
...
def XlsxSetCellBackgroundColor(
    file: object, sheet: str, row: int, column: int, color: str
) -> object:
    """
...
def XlsxSetCellFontStyle(
    file: object, sheet: str, row: int, column: int, style: str
) -> object:
    """
...
def XlsxAlignCellVertically(
    file: object, sheet: str, row: int, column: int, alignment: str
) -> object:
    """
...
def CreateWindowsLinkFile(
    target: str, link_file_path: str, mount_mapping_table: object
) -> bool:
    """
...
class QualityAssurance:
    ...
    def set_default_values(
        self,
        compare_time: float,
        compare_double: float,
        compare_int: float,
        compare_memory: float,
        down_limit_time: float,
        down_limit_double: float,
        down_limit_ints: int,
        down_limit_memory: float,
        up_limit_time: float,
        up_limit_double: float,
        up_limit_ints: int,
        up_limit_memory: float,
        compare_double_absolute: float,
        compare_ints_absolute: int,
        compare_time_absolute: float,
        compare_memory_absolute: float,
    ):
        """
    ...
    def add_current_memory_usage_value(
        self,
    ...
    def add_peak_memory_usage_value(
        self,
...
class ParallelJobsDispatcher:
    ...
    def __init__(
        ...
        command: str,
        max_num_workers: int,
        keep_workers_hot_time_limit: int,
        script_function_to_call: str,
        redirection_logs_path: str,
        job_time_limit: int,
        worker_launch_time_limit: int,
        worker_initialization_script: str,
        database_handling: str,
    ) -> object:
        """
...
def GetProcessSystemMetrics(
    measurement_type: str,
    measurement_units: str = "MB",
    memory_heap_measurement: bool = False,
) -> dict:
    """
