...
def split_shell(shell: base.Entity):
    ...
    complete_shell_entities = shell.get_entity_values(DECK, ("EID", "PID", "N1", "THIC1", "N2", "THIC2", "N3", "THIC3", "N4", "THIC4"))
    ...
    diag1 = dist(shell_entities["N1"], shell_entities["N3"])
    diag2 = dist(shell_entities["N2"], shell_entities["N4"])

    if diag1 < diag2:
        # Split along N1-N3 diagonal
        new_shell1, debug_report = base.CreateEntity(DECK, SHELL_TYPE, {"type": "TRIA", "PID": complete_shell_entities["PID"],
                                                             "N1": shell_entities["N1"], "THIC1": complete_shell_entities["THIC1"],
                                                             "N2": shell_entities["N2"], "THIC2": complete_shell_entities["THIC2"],
                                                             "N3": shell_entities["N3"], "THIC3": complete_shell_entities["THIC3"]}, debug=ansa.constants.REPORT_ALL)
        print(debug_report)
        print(f"Created new shell with ID {new_shell1._id}")

        new_shell2, debug_report = base.CreateEntity(DECK, SHELL_TYPE, {"type": "TRIA", "PID": complete_shell_entities["PID"],
                                                             "N1": shell_entities["N1"], "THIC1": complete_shell_entities["THIC1"],
                                                             "N2": shell_entities["N3"], "THIC2": complete_shell_entities["THIC3"],
                                                             "N3": shell_entities["N4"], "THIC3": complete_shell_entities["THIC4"]}, debug=ansa.constants.REPORT_ALL)
        print(debug_report)
        ...
        # Split along N2-N4 diagonal
        new_shell1, debug_report = base.CreateEntity(DECK, SHELL_TYPE, {"type": "TRIA", "PID": complete_shell_entities["PID"],
                                                             "N1": shell_entities["N2"], "THIC1": complete_shell_entities["THIC2"],
                                                             "N2": shell_entities["N3"], "THIC2": complete_shell_entities["THIC3"],
                                                             "N3": shell_entities["N4"], "THIC3": complete_shell_entities["THIC4"]}, debug=ansa.constants.REPORT_ALL)
        print(debug_report)
        print(f"Created new shell with ID {new_shell1._id}")
